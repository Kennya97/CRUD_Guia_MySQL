...
public class dto_producto {
    ...
    public dto_producto(int id_producto, String nom_producto, String des_producto, double stock, double precio, String unidad_medida, int estado_producto, int categoria) {
